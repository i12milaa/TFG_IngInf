...
El trabajo se considerará satisfactorio si el prototipo implementado cumple los siguientes criterios verificables: los nodos se conectan al servidor de forma autónoma y retoman su estado angular tras una reconexión sin intervención manual; el servidor asigna turnos de medida diferenciados a los nodos en situación de interferencia geométrica sin que se registren lecturas espurias atribuibles al \textit{crosstalk} acústico; el sistema produce estimaciones de posición cooperativas cuando la geometría lo permite; la interfaz gráfica refleja el estado de la red en tiempo real con una latencia inferior a un ciclo de medida; y el conjunto del sistema supera sin fallos los escenarios de prueba diseñados para validar los requisitos funcionales definidos en el capítulo correspondiente.
